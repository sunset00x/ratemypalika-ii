            ...
            <div class="form-container" style="margin: 0; width: 100%;">
                ...
                <form method="POST" action="categories.php">
                    ...
                    <div class="form-group">
                        <label>Category Key (System Identifier)</label>
                        ...
                        <small style="color: #64748b; font-size: 11px;">Lowercase letters and underscores only.</small>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <small style="color: #64748b; font-size: 11px;">Default is 1.0. Higher values weigh more in score calculation.</small>
                    </div>
                            ...
                            <?php else: ?>
                                <?php foreach ($categories as$cat): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <span style="font-weight: 600; font-size: 12px; padding: 3px 8px; border-radius: 4px; background: <?= (isset($cat['is_active']) &&$cat['is_active'] == 1) ? '#dcfce7; color: #166534;' : '#fef3c7; color: #92400e;' ?>">
                                                <?= (isset($cat['is_active']) &&$cat['is_active'] == 1) ? 'Active' : 'Disabled' ?>
                                            </span>
                                        </td>
